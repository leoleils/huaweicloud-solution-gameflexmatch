...
您可以将需要托管的应用包上传至`gamebounce`平台，自动化生成安装有监测、上报插件的应用包镜像，并用于fleet创建，支持VM和POD两种镜像打包模式。您也可以直接绑定华为云`IMS`或`SWR`中已有私有镜像，并快速构建fleet。
...
| OBS桶    | OBS桶名，用于存放应用包文件                                  | gamebounce        |
