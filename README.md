...
```sh
    ...
    # 上传appgateway-{version} 与 appgateway_run.sh，并修改相关配置(样例见：doc/build/appgateway/appgateway_run.sh)
    # 修改权限
...
```sh
    ...
    # 5. 上传create_fleet_workflow.json和delete_fleet_workflow.json，详见
